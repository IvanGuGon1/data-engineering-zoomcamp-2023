...
def write_bq(df: pd.DataFrame) -> None:
    ...
    df.to_gbq(
        ...
        destination_table="homework2.exercise3c",
...
def etl_gcs_to_bq(color:str,year:int,month:int) -> pd.DataFrame:
...
if __name__ == "__main__":
    ...
    year = 2019
    months = [2, 3]
    etl_parent_flow_homework(color,year,months)